...
var roomServices = angular.module('roomServices', []);
...
//utilities table
roomServices.directive('detail_room_utilitiesDirective', [function () {
	return {
		restrict: 'AE',
...
roomServices.provider('detail_room_utilitiesProvider', [function(){
...
//relax table
roomServices.directive('detail_room_relaxDirective', [function () {
	return {
		restrict: 'AE',
...
roomServices.provider('detail_room_relaxProvider', [function(){
	var defautlitem = true;
